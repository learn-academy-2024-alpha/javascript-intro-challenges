...
if(var1 === 5){
    ...
    console.log("var2 is strictly equal")   
}else{console.log("Check your work")}
// Does "LEARN" contain the subset "RN"?
var1 = "LEARN"
if(var1.includes("RN")){
    console.log("includes RN")
}
// Does "LEARN" contain the subset "rn"?
var1 = "LEARN"
if(var1.includes("rn")){
    console.log("includes rn")
}else{console.log("if it doesnt have the correct format then incorrect")}
